...
public class AccountCustomerResponse {
    ...
    public AccountCustomerResponse(String name, String email, String mobileNumber, AccountsDto accountsDto, CardResponse cardResponse, LoansResponse loansResponse) {
        this.name = name;
        this.email = email;
