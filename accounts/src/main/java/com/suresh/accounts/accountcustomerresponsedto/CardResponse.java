...
public class CardResponse {
    ...
    public CardResponse(String mobileNumber, String cardNumber, String cardType, Long totalLimit, Long amountUsed, Long availableAmount, String status) {
    ...
    public @Pattern(regexp = "^[0-9]{14}$", message = "Card number must be exactly 14 digits") String getCardNumber() {
        return cardNumber;
    }

    public void setCardNumber(@Pattern(regexp = "^[0-9]{14}$", message = "Card number must be exactly 14 digits") String cardNumber) {
        this.cardNumber = cardNumber;
    }
