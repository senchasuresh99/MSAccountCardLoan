package com.suresh.loans.responsedto;
...
public class LoansResponse {
    ...
    public LoansResponse(String mobileNumber, String loanType, String lonaNumber, long totalLoan, long amountPaid, long outstandingAmount) {
