...
public class CardsDto {
    ...
    public CardsDto(String mobileNumber, String cardNumber, String cardType, Long totalLimit, Long amountUsed, Long availableAmount) {
